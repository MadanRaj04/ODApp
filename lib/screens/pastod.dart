...
class pastod extends StatefulWidget {
  const pastod({Key? key}) : super(key: key);

  @override
  _pastodState createState() => _pastodState();
}

class _pastodState extends State<pastod> {
  ...
  void initState() {
    ...
    _fetchData();
    var fieldName = 'roll';
    FirebaseFirestore.instance.collection('userData').doc(getCurrentUserID()).get().then((DocumentSnapshot documentSnapshot) {
